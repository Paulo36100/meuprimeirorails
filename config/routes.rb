Rails.application.routes.draw do
  ...
  get 'stores/edit/:id' => 'stores#edit', as: 'storesedit'
  patch 'stores/update/:id' => 'stores#update', as: 'storesupdate'
  delete 'stores/destroy/:id' => 'stores#destroy', as: 'storesdestroy'
